  ...
  return (
    <div className="flex flex-col gap-4 rounded-lg bg-violet-50 px-4 py-5">
      <div className="space-y-1">
        <span className="text-sm/5 font-medium ledding-5 text-violet-700">
          Used Space
        </span>
        <p className="text-sm/5 font-medium ledding-5 text-violet-500">
          Your team has used 88% of your avaliable space. Need more?
        </p>
      </div>
      <div className="h-2 rounded-full bg-violet-100">
        <div className="h-2 w-5/6 rounded-full bg-violet-600"></div>
      </div>
